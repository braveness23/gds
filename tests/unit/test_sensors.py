...
class MockSensor(BaseSensor[TestData]):
    ...
    def __init__(self, fail_connect=False, fail_read=False, read_delay=0.0, **kwargs):
    ...
    def _read_sensor(self) -> TestData:
        ...
        return TestData(value=float(self.read_count), timestamp=time.time())
...
class TestBaseSensorLifecycle:
    ...
    def test_sensor_initialization(self):
        ...
        sensor = MockSensor(update_interval=1.0, sensor_name="TestSensor")
...
class TestSensorEventBus:
    ...
    def test_sensor_without_event_bus(self):
        ...
        sensor = MockSensor(update_interval=0.05, event_bus=None)
